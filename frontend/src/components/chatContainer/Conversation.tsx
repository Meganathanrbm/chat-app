...
export const Conversation = ({
  ...
  const isActive: boolean = conversation?._id === selectedConversation?._id; // selected conversation
  const isOnline: boolean = onlineUsers?.includes(conversation?._id); // online status

  const handleSeen = async (): Promise<APIResponseTy<string> | null> => {
    try {
  ...
  const handleSelectConversation = async (): Promise<void> => {
