...
import { SignUpScreen2Data } from "../../types/pages";
...
const SignUpScreen2 = () => {
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<SignUpScreen2Data>();
  const { loading, signup } = useSignUp();
  const onSubmit: SubmitHandler<SignUpScreen2Data> = async (data) => {
    const emailId = sessionStorage.getItem("current-user-emailID") ?? ""; // Ensuring no null values
